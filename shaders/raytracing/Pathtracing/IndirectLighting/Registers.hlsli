...
Texture2D<float>                            Depth                       : register(t13);
Texture2D<float4>                           Albedo                      : register(t14);
Texture2D<float4>                           EmissiveMetallic            : register(t15);
Texture2D<float4>                           NormalRoughness             : register(t16);
Texture2D<uint>                             Material                    : register(t17);
