...
namespace RE
{
	...
	class __declspec(novtable) NiSkinInstance : 
		public NiObject
	{
	public:
		static constexpr auto RTTI{ RTTI::NiSkinInstance };
		static constexpr auto VTABLE{ VTABLE::NiSkinInstance };
		static constexpr auto Ni_RTTI{ Ni_RTTI::NiSkinInstance };

		NiSkinInstance() { REX::EMPLACE_VTABLE(this); }
		virtual ~NiSkinInstance() = default;  // NOLINT(modernize-use-override) 00
