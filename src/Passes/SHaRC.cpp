...
namespace Pass
{
	SHaRC::SHaRC(Renderer* renderer, RaytracingCommon* raytracingCommon, LightTLAS* lightTLAS)
		: RenderPass(renderer), m_RaytracingCommon(raytracingCommon), m_LightTLAS(lightTLAS)
	{
