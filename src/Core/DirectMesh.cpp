...
DirectMesh::DirectMesh(RE::BSTriShape* bsTriShape, [[maybe_unused]] nvrhi::ICommandList* commandList)
{
	...
	m_GeometryDescs.push_back(MakeGeometryDesc(m_IndexBuffer.m_Buffer, 0, indexCount, m_VertexBuffer.m_Buffer, vertexStride, triShapeData.vertexCount, GetMeshIndex()));
